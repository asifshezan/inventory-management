    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="row">
                ...
                <i class="fab fa-gg-circle"></i>Update Purchase-Unit Information</div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('purchase.unit.update', $data->pu_slug) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row d-flex justify-content-center">
                                <div class="col-md-6">
                                    <div class="form-group pb-2 {{ $errors->has('pu_name') ? 'has-error':'' }}">
                                        ...
                                        <input type="hidden" name="pu_id" value="{{ $data->pu_id }}">
                                    ...
                                    <div class="form-group pb-2">
                                        ...
                                        <textarea class="form-control" name="pu_remarks">{{ $data['pu_remarks'] }}</textarea>
                                    </div>
                                    <div class="form-group pb-2">
