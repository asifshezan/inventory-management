                            ...
                            <div class="row">
                                <div class="col-md-9 form-group">
                                    <div class="mb-3  {{ $errors->has('department_name') ? 'has-error':'' }}">
                                        ...
                                        <input type="text" class="form-control"  placeholder="Enter Your department_name" name="department_name" value="{{ old('department_name') }}">
                                    ...
                                    <div class="form-group pb-2">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="department_remarks" placeholder="Enter Your remarks" value="{{ old('department_remarks') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
