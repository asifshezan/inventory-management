    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="row">
                ...
                <i class="fab fa-gg-circle"></i>Update Customer-Group</div>
                        ...
                        <p class="pera">The field labels marked with * are required input fields.</p>
                            <div class="row">
                                <div class="col-md-6 {{ $errors->has('cg_name') ? 'has-error':'' }}">
                                    <div class="mb-3">
                                        <input type="hidden" name="cg_id" value="{{ $data->cg_id }}">
                                        <label for="formrow-email-input" class="form-label form_label">Customer Group Name<span class="req_star">*</span></label>
                                        <input type="text" class="form-control"  placeholder="Enter Your cg_name" name="cg_name" value="{{ $data->cg_name }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control"  placeholder="Enter Your cg_remarks" name="cg_remarks" value="{{ $data->cg_remarks }}">
                                    </div>
                                </div>
                            </div>
                            <div>
