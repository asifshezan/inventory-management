    ...
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="row">
                ...
                <i class="fab fa-gg-circle"></i>Add Biller Information</div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('biller.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3 {{ $errors->has('biller_name') ? 'has-error':'' }}">
                                        ...
                                        <input type="text" class="form-control"  placeholder="Enter Your Name" name="biller_name">
                                ...
                                <div class="form-group pb-2">
                                    <div class="mb-3 {{ $errors->has('biller_email') ? 'has-error':'' }}">
                                        ...
                                        <input type="email" class="form-control" name="biller_email" placeholder="Enter Your biller_email ID">
                                ...
                                <div class="form-group pb-2">
                                    <div class="mb-3 {{ $errors->has('biller_company') ? 'has-error':'' }}">
                                        ...
                                        <input type="text" class="form-control"  placeholder="Enter Your Name" name="biller_company">
                                ...
                                <div class="form-group pb-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="biller_city" placeholder="Enter Your City">
                                    </div>
                                </div>
                                <div class="form-group pb-2">
                                ...
                                <div class="form-group pb-2">
                                    <div class="mb-3 {{ $errors->has('biller_phone') ? 'has-error':'' }}">
                                        <label  class="form-label form_label">Phone Number<span class="req_star">*</span></label>
                                        <input type="text" class="form-control" name="biller_phone" placeholder="Enter Your biller_phone">
                                        @if ($errors->has('biller_phone'))
                                            <span class="error">{{ $errors->first('biller_phone') }}</span>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-group pb-2">
                                    <div class="mb-3 {{ $errors->has('biller_address' ? 'has-error':'') }}">
                                        ...
                                        <input type="text" class="form-control" name="biller_address" placeholder="Enter Your Address">
                                ...
                                <div class="form-group pb-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="biller_country" placeholder="Enter Your Phone Number">
                                    </div>
                                </div>
                            </div>
                        </div>
