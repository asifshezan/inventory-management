            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('expense.category.update', $data->expcate_slug) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-6 {{ $errors->has('expcate_code') ? 'has-error':'' }}">
                                    <div class="form-group pb-2">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number"  name="expcate_code" class="form-control" value="{{ $data->expcate_code }}">
                                    ...
                                    <div class="form-group pb-2 {{ $errors->has('expcate_name') ? 'has-error':'' }}">
                                        ...
                                        <input type="text" name="expcate_name" class="form-control" value="{{ $data->expcate_name }}">
                                    ...
                                    <div class="form-group pb-2">
                                        ...
                                        <textarea class="form-control" name="expcate_remarks" value="{{ $data->expcate_remarks }}"></textarea>
                                    </div>
                                    <div class="form-group pb-2">
