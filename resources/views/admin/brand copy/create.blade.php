    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="row">
                ...
                <i class="fab fa-gg-circle"></i>Add WareHouse</div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3 {{ $errors->has('wh_name') ? 'has-error':'' }}">
                                        ...
                                        <input type="text" class="form-control"  placeholder="Enter Your wh_name" name="wh_name" value="{{ old('wh_name') }}">
                                ...
                                <div class="form-group pb-2">
                                    <div class="mb-3 {{ $errors->has('wh_email') ? 'has-error':'' }}">
                                        ...
                                        <input type="email" class="form-control"  placeholder="Enter Your wh_email" name="wh_email" value="{{ old('wh_email') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group pb-2">
                                        <div class="mb-3 {{ $errors->has('wh_phone') ? 'has-error':'' }}">
                                            ...
                                            <input type="text" class="form-control"  placeholder="Enter Your wh_phone" name="wh_phone" value="{{ old('wh_phone') }}">
                                    ...
                                    <div class="form-group pb-2">
                                        <div class="mb-3 {{ $errors->has('wh_address') ? 'has-error':'' }}">
                                            ...
                                            <textarea type="text" class="form-control"  placeholder="Enter Your wh_address" name="wh_address" value="{{ old('wh_address') }}"></textarea>
