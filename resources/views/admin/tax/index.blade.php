...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="row">
                ...
                <i class="fab fa-gg-circle"></i>All Tax Information</div>
                <div class="col-md-4 card_header_btn">
                    <a class="btn btn-primary waves-effect waves-light chb_btn" href="{{ route('tax.create' )}}"><i class="fas fa-plus-circle"></i> Add Tax</a>
                    </div>
            </div>
            </div>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item text-primary btn-link" href="{{ route('tax.edit', $data->tax_slug) }}"><i class="dripicons-document-edit"></i> Edit</a>
                                    <a class="dropdown-item text-primary btn-link" href="#" id="delete" data-bs-toggle="modal" data-bs-target="#softDeleteModal" data-id="{{$data->tax_id}}"><i class="dripicons-trash"></i> Delete</a>
                                </div>
                            </div>
                        </td>
                    </tr>
    ...
    <div class="modal-dialog">
        <form method="post" action="{{ route('tax.softdelete')}}">
        @csrf
