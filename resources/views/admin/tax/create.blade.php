                            ...
                            <div class="row d-flex justify-content-center">
                                ...
                                <div class="form-group pb-2 {{ $errors->has('tax_name') ? 'has-error':'' }}">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control"  placeholder="Enter Your tax_name" name="tax_name" value="{{ old('tax_name') }}">
                                ...
                                <div class="form-group pb-2 {{ $errors->has('tax_percent') ? 'has-error':'' }}">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control"  placeholder="Enter Your tax_percent" name="tax_percent" value="{{ old('tax_percent') }}">
                                ...
                                <div class="form-group pb-4">
                                    ...
                                    <textarea class="form-control" name="tax_remarks" value="{{ old('tax_remarks') }}"></textarea>
                                </div>
