    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('role.update', $data->role_slug) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                        <p class="pera">The field labels marked with * are required input fields.</p>

                            <div class="row">
                                <div class="col-md-6 {{ $errors->has('role_name') ? 'has-error':'' }}">
                                    <div class="mb-3">
                                        <input type="hidden" name="role_id" value="{{ $data->role_id }}"/>
                                        <label for="formrow-email-input" class="form-label form_label">Role Name<span class="req_star">*</span></label>
                                        <input type="text" class="form-control"  placeholder="Enter Your Name" name="role_name" value="{{ $data->role_name }}">
