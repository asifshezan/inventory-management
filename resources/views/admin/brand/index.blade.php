    ...
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="row">
                ...
                <i class="fab fa-gg-circle"></i>All Brand Information</div>
                <div class="col-md-4 card_header_btn">
                    <a class="btn btn-primary waves-effect waves-light chb_btn" href="{{ route('brand.create' )}}"><i class="fas fa-plus-circle"></i> Add Brand</a>
                    </div>
            </div>
            </div>
            ...
            <div class="row">
                ...
                <table id="dataTable" class="table table-bordered table-striped table-hover custom_table custom_table">
                    ...
                    @foreach($all as $data)
                    <tr>
                        <td>@if($data->brand_image)
                            <img height="40" src="{{ asset('uploads/brands/' . $data->brand_image) }}"/>
                        @else
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item text-primary btn-link" href="{{ route('brand.edit', $data->brand_slug) }}"><i class="dripicons-document-edit"></i> Edit</a>
                                    <a class="dropdown-item text-primary btn-link" href="#" id="delete" data-bs-toggle="modal" data-bs-target="#softDeleteModal" data-id="{{$data->brand_id}}"><i class="dripicons-trash"></i> Delete</a>
                                </div>
                            </div>
                        </td>
                    </tr>
