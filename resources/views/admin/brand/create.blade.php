    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="row">
                ...
                <i class="fab fa-gg-circle"></i>Add Brand</div>
                <div class="col-md-4 card_header_btn">
                <a class="btn btn-primary waves-effect waves-light chb_btn" href="{{ route('brand.index') }}"><i class="fas fa-th"></i> All Brand</a>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 {{ $errors->has('brand_name') ? 'has-error':'' }}">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control"  placeholder="Enter Your brand_name" name="brand_name" value="{{ old('brand_name') }}">
